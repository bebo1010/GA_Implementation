...
class Genetic_Algorithm_Float(object):
    def __init__(self, function: callable, name_bounds_dict: dict, population_size: int = 1000, crossover_rate: float = 0.95, mutation_rate: float = 0.1, max_iterations: int = 500, relative_change_threshold: float = 0.0003, stopping_iteration_threshold: int = 10):
        """
        ...
        `mutation_rate` (float): Probability of Mutation in Genetic Algorithm, should be within [0, 1]. Default value is 0.1.\n
        ...
        file_handler = logging.FileHandler(self.output_dir + "Genetic_Algorithm_Float_min_log.txt", mode="w")
    ...
    def tournament_selection(self, states_list: list[dict], function_values_list: list, tournament_size: int = 10) -> list[dict]:
        ...
        for _ in range(self.population_size // tournament_size):
            ...
            fittest_index = tournament_indices[tournament_function_values.index(min(tournament_function_values))]
